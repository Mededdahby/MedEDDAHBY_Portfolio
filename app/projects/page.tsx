...
const allProjects = [
  ...
  },
  {
    ...
    liveUrl: "",
    sourceUrl: "https://github.com/Mededdahby/islamic-learning-hub",
  ...
  },
  {
    ...
    liveUrl: "",
    sourceUrl: "https://github.com/Mededdahby/virtual-mouse",
  ...
  },
  {
    ...
    description:
      "Interactive dashboard displaying COVID-19 statistics with charts and data visualization.",
    liveUrl: "",
  ...
  },
  {
    ...
    description:
      "A simulation of processor operations and architecture implemented in C.",
    liveUrl: "",
  ...
  },
  {
    ...
    description:
      "An interactive quiz platform built with React and Express.js for creating and taking quizzes.",
  ...
  },
  {
    ...
    liveUrl: "https://mededdahby.netlify.app/",
    sourceUrl: "https://github.com/Mededdahbyy/fitness_App",
...
const years = [
  ...new Set(
    allProjects.map((project) => new Date(project.date).getFullYear())
  ),
].sort((a, b) => b - a);
      ...
      >
        <div className="p-6 flex flex-col h-full">
          <div className="flex justify-between items-center mb-3">
            ...
            <span className="text-sm bg-[#ff6b6b]/10 text-[#ff6b6b] px-3 py-1 rounded-full">
              {project.category}
            </span>
          </div>
...
export default function ProjectsPage() {
  ...
  return (
    <main className="pt-24 pb-20 bg-gradient-to-br from-[#bdc3f154] to-[#d0aeff42] dark:from-[#0a0a20] dark:to-[#1a1a40] min-h-screen px-4 md:px-8 lg:px-16">

...
export default function Projects() {
  ...
  return (
    <section
      id="projects"
      className="py-20 bg-gradient-to-br from-[#f8f1f1] to-[#ddedee] dark:from-[#0a0a20] dark:to-[#1a1a40] px-4 md:px-8 lg:px-16"
    >
      <div className="max-w-7xl mx-auto">
        <div className="mb-16 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl  font-serif font-bold mx-auto mt-4">
        ...
        <div className="mt-16 text-center">
          <Button
            asChild
            className="bg-[#ff6b6b] hover:bg-[#ff5252] text-white rounded-full px-8 group"
          >
